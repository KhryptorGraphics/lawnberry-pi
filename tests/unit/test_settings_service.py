...
def sample_profile():
    ...
    return SettingsProfile(
        ...
        telemetry=TelemetrySettings(stream_enabled=True, persist_enabled=True, retention_days=30),
        control=ControlSettings(lockout_enabled=True, lockout_timeout=30, blade_safety=True),
        maps=MapsSettings(
            provider="leaflet",
            api_key=None,
        ...
        camera=CameraSettings(enabled=True, resolution="1280x720", framerate=30, quality=80),
        ai=AISettings(
