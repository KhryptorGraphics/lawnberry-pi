...
| `/tractor` | Tractor Control | Manual actuation of the zero-turn ride-on mower (left lever, right lever, throttle, blade PTO, starter) with live state, via `/api/v2/tractor/*` — see `tractor-platform.md` |
