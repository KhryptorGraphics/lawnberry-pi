    ...
    if "source" in telemetry_data and telemetry_data["source"] in {
        ...
        result = {
            ...
            "position": {
                ...
                "satellites": position_data.get("satellites", None),
                "hdop": position_data.get("hdop", None),
        ...
        result = {
            ...
            "position": {
                ...
                "altitude": telemetry_data.get("position", {}).get("altitude", None),
                "accuracy": telemetry_data.get("position", {}).get("accuracy", None),
                "gps_mode": telemetry_data.get("position", {}).get("gps_mode", None),
                "satellites": telemetry_data.get("position", {}).get("satellites", None),
                "hdop": telemetry_data.get("position", {}).get("hdop", None),
                "rtk_status": telemetry_data.get("position", {}).get("rtk_status", "simulated"),
                "rtk_fallback_message": None,
            },
            "imu": {
                "roll": None,
