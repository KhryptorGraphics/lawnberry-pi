...
def _poly_from_positions(boundary: Sequence[Position]) -> LocalPolygon:
    ...
    return LocalPolygon(polygon=poly, origin_lat=origin_lat, origin_lon=origin_lon)
...
def generate_lawnmower(
    ...
    *,
    ...
    local_poly = _poly_from_positions(boundary)
    poly = local_poly.polygon
    origin_lat = local_poly.origin_lat
    origin_lon = local_poly.origin_lon
