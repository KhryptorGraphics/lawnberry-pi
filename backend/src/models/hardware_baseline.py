...
class HardwareBaseline(BaseModel):
    ...
    def validate_configuration(self) -> list[str]:
        ...
        if (
            self.ai_accelerator == AIAcceleratorType.HAILO_HAT
            and self.drive_controller == DriveControllerType.ROBOHAT_CYTRON
        ):
    ...
    def create_standard_baseline(cls) -> "HardwareBaseline":
        ...
        baseline = cls(
            baseline_id="standard_v2", baseline_name="LawnBerry Pi v2 Standard Configuration"
        )
