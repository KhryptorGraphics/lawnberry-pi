...
class SecurityContext(BaseModel):
    ...
    def is_locked_out(self) -> bool:
        ...
        return self.account_locked or self.login_attempts >= self.max_login_attempts
...
class UserSession(BaseModel):
    ...
    def update_activity(self, action: str, **kwargs):
        ...
        activity = SessionActivity(action=action, **kwargs)
    ...
    def add_websocket_connection(self, connection_id: str, endpoint: str = "/ws/telemetry"):
        ...
        connection = WebSocketConnection(connection_id=connection_id, endpoint=endpoint)
    ...
    def create_operator_session(
        ...
        session = cls(client_ip=client_ip, user_agent=user_agent)
